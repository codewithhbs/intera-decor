...
const Hero = () => {
        ...
        const fetchHeroPageData = async () => {
            try {
                ...
                const response = await axios.get(
                    "https://api.interdecor.adsdigitalmedia.com/api/v1/admin/get/hero_page"
                );
    ...
    const updateHeroPageData = async () => {
        try {
            setLoading(true);
            await axios.post("https://api.interdecor.adsdigitalmedia.com/api/v1/admin/create_and_update/hero_page", heroPageData);
