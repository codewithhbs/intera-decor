...
const EditAboutUs = () => {
  ...
  const getUrl = "https://api.interdecor.adsdigitalmedia.comapi/v1/get-about";
  const editUrl = "https://api.interdecor.adsdigitalmedia.comapi/v1/create-or-update-about";
