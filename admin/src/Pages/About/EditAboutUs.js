...
const EditAboutUs = () => {
  ...
  const getUrl = "https://api.interdecor.adsdigitalmedia.com/api/v1/get-about";
  const editUrl = "https://api.interdecor.adsdigitalmedia.com/api/v1/create-or-update-about";
