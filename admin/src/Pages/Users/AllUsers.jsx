...
const AllUsers = () => {
  ...
  const fetchUsers = async () => {
    setLoading(true);
    try {
      const response = await axios.get('https://api.creativencolourful.com/api/v1/admin/get-users');
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await axios.delete(`https://api.creativencolourful.com/api/v1/admin/delete/${id}`);
