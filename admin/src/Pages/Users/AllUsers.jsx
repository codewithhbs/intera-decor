...
const AllUsers = () => {
  ...
  const fetchUsers = async () => {
    setLoading(true);
    try {
      const response = await axios.get('https://api.interdecor.adsdigitalmedia.comapi/v1/admin/get-users');
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await axios.delete(`https://api.interdecor.adsdigitalmedia.comapi/v1/admin/delete/${id}`);
