...
import CreateOrUpdateSlider from './Pages/Slider/CreateOrUpdateSlider';
      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          <Route path="/" element={<DashboardLayout />}>
            ...
            <Route path="/admin/hero-slider" element={<AllSliders />} />
            <Route path="/admin/hero-slider/edit/:id" element={<CreateOrUpdateSlider />} />
            <Route path="/admin/hero-slider/new" element={<CreateOrUpdateSlider />} />
