...
const multerDisc =  require('../middleware/multer.disk');
const { createHeroSlider, getAllHeroSliders, getHeroSlider, updateHeroSlider, deleteHeroSlider } = require("../controller/SliderController");
...
router.post("/admin/create/category", multerDisc.single("image"), createCategory);
router.get("/admin/category", getCategories);
router.get("/admin/category/:id", getCategoryById);
router.put("/admin/category/edit/:id", multerDisc.single("image"), updateCategory);
...
router.post("/HeroSlider", multerDisc.single("image"), createHeroSlider);
router.get("/HeroSlider", getAllHeroSliders);
router.get("/HeroSlider/:id", getHeroSlider);
router.put("/HeroSlider/:id", multerDisc.single("image"), updateHeroSlider);
router.delete("/HeroSlider/:id", deleteHeroSlider);
